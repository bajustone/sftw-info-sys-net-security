...
\begin{abstract}
Signcryption is a public-key cryptographic primitive that simultaneously provides message confidentiality and authentication in a single logical step, achieving both functions at a cost significantly lower than the traditional ``signature-then-encryption'' approach. Since its introduction by Zheng in 1997, signcryption has attracted substantial academic attention, resulting in formal security models, constructions based on diverse hardness assumptions, extensions to identity-based and elliptic curve settings, and ultimately international standardization through ISO/IEC 29150. This paper presents a comprehensive review of the signcryption literature, tracing its evolution from the original ElGamal-based construction through the formalization of security proofs by Baek et al.\ and An et al., to identity-based variants proposed by Malone-Lee and Boyen. A comparative analysis evaluates these schemes across dimensions of efficiency, security guarantees, and underlying mathematical assumptions. Critically, this review identifies and examines a persistent gap between signcryption's theoretical maturity and its practical deployment: despite proven efficiency advantages and ISO standardization, no major cryptographic library or widely deployed protocol has adopted signcryption. We analyze the factors contributing to this gap---including ecosystem inertia, modularity concerns, and post-quantum uncertainty---and identify open challenges and initial steps toward bridging theory to practice.
\end{abstract}
